...
for (const [id, names, excluded] of [
  ...
  ['ucl-2026-27-md01-12', ['Gilmour', 'Marin', 'Konsa'], /McTominay|David Neres|Zubimendi|Havertz/i],
...
assert.equal(calendar.fixtures[12].probableFormation.status, 'editorial-probable');
