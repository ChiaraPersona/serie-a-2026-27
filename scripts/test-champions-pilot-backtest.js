...
for (const [metric, result] of Object.entries(report.metrics)) {
  ...
  assert(result.mae < result.baselineMae, `${metric}: MAE non migliore della baseline`);
...
console.log("OK backtest volumi Champions: quattro metriche sopra baseline e cartellini partita controllati");
