...
const readingOrder=["reading-h2h-section","reading-info-grid","reading-referee-assignment","prediction-volume-section","reading-panel-grid"].map(contract=>app.innerHTML.indexOf(contract));
