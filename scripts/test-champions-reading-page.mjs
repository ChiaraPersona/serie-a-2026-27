...
assert.equal((app.innerHTML.match(/class="reading-lineup-row"/g)||[]).length,8);
assert(app.innerHTML.includes("<span>Real Madrid</span><strong>4-3-3</strong>"));
assert(app.innerHTML.includes("<span>Inter</span><strong>3-5-2</strong>"));
assert(app.innerHTML.includes('aria-label="Formazione ufficiale Real Madrid con modulo 4-3-3"'));
assert(app.innerHTML.includes('aria-label="Formazione ufficiale Inter con modulo 3-5-2"'));
assert(app.innerHTML.includes("Confermate · Diretta"));
assert(app.innerHTML.includes("Confidenza XI"));
assert(app.innerHTML.includes("Ufficiali"));
