...
const homeVersion = "20260907-cagliari-lecce-official-v1";
const calendarVersion = "20260906-personal-calendar-all-competitions-v1";
const teamVersion = "20260907-cagliari-lecce-official-v1";
const leaderboardVersion = "20260906-md3-eight-results-v1";
const bettingVersion = "20260907-cagliari-lecce-official-v1";
const readingVersion = "20260907-cagliari-lecce-official-v1";
const cupVersion = "20260903-coppa-results-v1";
const championsVersion = "20260907-champions-reading-order-v2";
const fantasyVersion = "20260907-cagliari-lecce-official-v1";
