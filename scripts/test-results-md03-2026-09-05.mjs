...
assert.deepEqual(totals, { won: 10, lost: 3 }, "Liquidazione parziale MD3 inattesa");
console.log("Risultati MD3 validi: Genoa-Como 1-4, Fiorentina-Torino 1-2; Schedina 10 esatte e 3 sbagliate.");
