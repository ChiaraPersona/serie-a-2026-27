...
assert.ok(teamInterface.includes('<details class="team-season-group" open>') && teamInterface.includes('<details class="team-season-group"><summary>Disciplina</summary>'), "Le statistiche dense devono usare sottosezioni compatte");
