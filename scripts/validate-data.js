...
assert((match=>match?.status==="finished"&&match.score?.home===2&&match.score?.away===1&&match.resultCoverage?.playerStats==="unavailable")(finishedLeagueMatches.find(match=>match.id==="monza-sassuolo-2026-27-md-05")),"Risultato Monza-Sassuolo non aggiornato o copertura mancante non esplicita");
