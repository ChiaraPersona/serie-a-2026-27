export function createPage(deps){
  ...
  function matchAttackChannelsPanel(fixture,attackByTeam,branding){
    ...
    return `<section class="section champions-reading-attack" aria-labelledby="champions-reading-attack-title"><header class="section-heading"><div><p class="eyebrow">WhoScored · baseline 2025/26</p><h2 id="champions-reading-attack-title">Fasce d'attacco</h2></div><p>Distribuzione storica separata dai volumi di gara.</p></header><div>${card(fixture.homeTeam)}${card(fixture.awayTeam)}</div></section>`;
  }
  ...
  function pilotReadingDetail(fixture,pilot,backtest,squads,branding,h2h,motivationEntry,styleProfiles,attackByTeam){
  ...
  async function render(){
    ...
    if(requestedFixture){
      document.querySelector("#app").innerHTML=pilotReadingDetail(requestedFixture,pilot,backtest,squads,branding,h2h,motivationByFixture.get(requestedMatchId),styleProfiles,attackByTeam);
      return;
    }
