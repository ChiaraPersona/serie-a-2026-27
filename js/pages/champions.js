export function createPage(deps){
  ...
  function pilotReadingDetail(fixture,pilot,backtest,squads,branding,h2h,motivationEntry){
    ...
    return `<nav class="reading-back champions-reading-back"><a href="champions-league.html">← Tutte le letture</a><span>Giornata 1</span></nav>
      ...
      <nav class="champions-reading-index" aria-label="Indice della lettura"><strong>Vai a</strong><a href="#champions-forecast">Pronostico</a><a href="#champions-lineups">Formazioni</a><a href="#champions-context">Contesto</a><a href="#champions-history">Precedenti</a></nav>
      <section class="section reading-projection-prototype prediction-volume-section champions-reading-volume" id="champions-forecast"><header class="section-heading"><div><p class="eyebrow">Pronostico e dati di gara</p><h2>Scenario principale</h2></div><p>Esito, risultato coerente e fascia gol prima dei dati secondari.</p></header>${goalForecast}<details class="champions-reading-data-details"><summary><span><strong>Volumi e proiezioni per squadra</strong><small>Tiri, specchio, corner, falli e cartellini</small></span><b>Apri</b></summary><div class="champions-reading-data-body">${matchProjection}<div class="prediction-volume-grid">${fixture.teamProjections.map(teamProjection).join("")}</div><p class="objective-method">Storico distinto tra casa e trasferta. Tiri e corner combinano produzione per sede, valori concessi dall'avversaria e ultime otto gare; le fasce sono percentili p20–p80, non margini fissi. La designazione arbitrale è verificata ma non viene applicata come moltiplicatore automatico dei cartellini. I dati mancanti restano N/D.</p></div></details></section>
