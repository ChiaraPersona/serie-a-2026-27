...
export function createPage(deps){
  ...
  function championsArchiveCard(data){
    return `<a class="betting-archive-card betting-archive-card--champions team-directory-card team-flip-card" href="schedina.html?competizione=champions" aria-label="Apri la schedina Champions League" style="--team-primary:#0756c9;--team-secondary:#02183f"><span class="team-flip-inner"><span class="team-flip-face team-flip-front betting-archive-card-front betting-champions-front" style="background:radial-gradient(circle at 70% 18%,rgba(80,196,255,.5),transparent 42%),linear-gradient(145deg,#0966e8,#031b4b)!important;color:#fff"><span class="betting-archive-number">CL</span><small>UEFA</small></span><span class="team-flip-face team-flip-back betting-archive-card-back"><strong>Champions League</strong><span>1ª giornata · 2026/27</span><span>${data.slips.length} schedine</span><span class="betting-archive-performance"><span><small>Selezioni</small><strong>${data.summary.legs}</strong></span><span><small>Partite</small><strong>${data.summary.distinctFixtures}</strong></span></span><span>Quote aggiornate al ${esc(dateOnly(data.oddsRetrievedAt))}</span><b>Apri le schedine Champions</b></span></span></a>`;
  }
