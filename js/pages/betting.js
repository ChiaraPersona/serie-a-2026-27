...
export function createPage(deps){
  ...
  async function render(){
    ...
    document.querySelector("#app").innerHTML=hero("Archivio · Stagione 2026/27","Schedina","Le schedine restano raccolte giornata per giornata, con quote, valutazioni ed esiti sempre consultabili.")+`<section class="betting-archive" aria-labelledby="betting-archive-title"><header class="betting-archive-intro"><div><p class="eyebrow">Archivio schedine</p><h2 id="betting-archive-title">Giornate</h2></div><p>Seleziona una giornata per consultare tutte le schedine archiviate.</p></header><div class="betting-archive-list"><details class="betting-archive-card"><summary class="betting-archive-card-heading"><span class="betting-archive-round"><span class="eyebrow">Serie A · 2026/27</span><strong id="betting-round-01-title">1ª giornata</strong></span><span class="betting-archive-meta" aria-label="Riepilogo prima giornata"><span><strong>${data.slips.length}</strong> schedine</span><span>Quote ${esc(data.provider)}</span></span></summary><div class="betting-archive-card-content" aria-labelledby="betting-round-01-title">${roundContent}</div></details></div></section>`;
  }
  return {render};
}
