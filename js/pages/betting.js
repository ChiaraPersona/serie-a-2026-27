...
export function createPage(deps){
  ...
  async function render(){
    ...
    document.querySelector("#app").innerHTML=hero("Archivio · Stagione 2026/27","Schedina","Le schedine restano raccolte giornata per giornata, con quote, valutazioni ed esiti sempre consultabili.")+`<section class="betting-archive" aria-labelledby="betting-archive-title"><header class="betting-archive-intro"><div><p class="eyebrow">Archivio schedine</p><h2 id="betting-archive-title">Giornate</h2></div><p>Ogni card conserva tutte le proposte pubblicate per una singola giornata di campionato.</p></header><article class="betting-archive-card" aria-labelledby="betting-round-01-title"><header class="betting-archive-card-heading"><div><p class="eyebrow">Serie A · Prima giornata</p><h2 id="betting-round-01-title">1ª giornata</h2><p>Tutte le schedine della giornata, dalle selezioni del modello agli scenari editoriali e di laboratorio.</p></div><div class="betting-archive-meta" aria-label="Riepilogo prima giornata"><span><strong>${data.slips.length}</strong> schedine</span><span>Quote ${esc(data.provider)}</span></div></header>${roundContent}</article></section>`;
  }
  return {render};
}
