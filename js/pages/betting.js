...
export function createPage(deps){
  ...
  function myComboRoundContent(predictions,matchById,teamById){
    ...
    return `<section class="betting-mycombo-round" aria-labelledby="betting-mycombo-md05-title"><header class="betting-section-heading"><div><p class="eyebrow">Una per ogni partita</p><h3 id="betting-mycombo-md05-title">MyCombo · 10 esiti per gara</h3></div><p>Ogni proposta contiene esattamente 10 esiti. Per le gare concluse gli esiti verificabili sono aggiornati sul referto: quelli presi sono evidenziati in verde, mentre i dati non coperti restano da verificare.</p></header><div class="betting-slip-grid">${cards}</div></section>`;
  }
