...
export function createPage(deps){
  ...
  function myComboRoundContent(predictions,matchById,teamById){
    ...
    return `<section class="betting-mycombo-round" aria-labelledby="betting-mycombo-md05-title"><header class="betting-section-heading"><div><p class="eyebrow">Una per ogni partita</p><h3 id="betting-mycombo-md05-title">MyCombo · 10 esiti selezionabili</h3></div><p>Le dieci gare sono presentate usando soltanto lo snapshot pre-partita, senza risultato né esiti successivi. Ogni card contiene dieci proposte cliccabili esclusivamente qui; handicap, mercati asiatici, monitor VAR e calcio di rigore sono esclusi.</p></header><div class="betting-slip-grid">${cards}</div></section>`;
  }
