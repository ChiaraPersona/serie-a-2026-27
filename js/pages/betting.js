...
export function createPage(deps){
  ...
  function myComboRoundContent(predictions,matchById,teamById){
    ...
    return `<section class="betting-mycombo-round" aria-labelledby="betting-mycombo-md05-title"><header class="betting-section-heading"><div><p class="eyebrow">Una per ogni partita</p><h3 id="betting-mycombo-md05-title">MyCombo delle singole partite · 5ª giornata</h3></div><p>Dieci combinazioni visibili, una per gara, con mercati realmente differenti e nessuna quota singola inferiore a 1,15.</p></header><div class="betting-slip-grid">${cards}</div></section>`;
  }
