# Serie A monochrome team logos

Black and white variants downloaded on 2026-07-28 from
[FootyLogos](https://www.footylogos.com/logos/serie-a-italy).
...
`manifest.json` maps the repository team IDs to the corresponding FootyLogos
pages and source slugs.
